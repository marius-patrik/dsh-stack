...
A plugin may require another plugin, optionally depend on another plugin, expose services/events/tools/commands/UI surfaces, be bundled into one or more packs, and be independently enabled or disabled.
...
Every external system gets its own integration plugin. Examples include GitHub, GitHub Projects, Trello, GitLab, Forgejo, Hypixel, broker/data vendors, and other SaaS or external APIs.

## Packs and profiles

A pack is a reusable composition of feature plugins. A profile is a product composition of packs, plugins and policy.
