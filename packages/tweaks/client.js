  ...
  factory: (require) => {
    ...
    function NewSessionButton(props) {
      ...
      return h(
        ...
        h(
          P.Tooltip,
          { label: "New", delayMs: 500, disabled: wide },
          h(
            "button",
            {
              type: "button",
        ...
        h(SelectDropdownMenu, {
          ...
          items: [
            { id: "chat", label: "New Chat Session", icon: h(ChatGlyph, { size: 14 }) },
            {
              ...
              icon: h(TerminalsGlyph, { size: 14 }),
            },
            {
              id: "container",
              label: "New Sandbox Container",
              icon: h(ContainersGlyph, { size: 14 }),
            },
          ],
    ...
    function TweaksSidebarRoot(props) {
      ...
      var settled = settledState[0],
        setSettled = settledState[1];
      React.useEffect(
        function () {
          if (!collapsed) {
            setSettled(false);
      ...
      return h(
        ...
        h(
          "div",
          { className: "dsh-tw-logoRow" },
          wide
            ? h(
                "button",
                {
                  type: "button",
                  className: "dsh-tw-brand dsh-tw-wide",
          ...
          h(
            P.Tooltip,
            { label: collapsed ? t("toggle.open") : t("toggle.collapse"), delayMs: 500 },
            h(
              "button",
              {
                type: "button",
                className: "dsh-tw-iconButton dsh-tw-toggle",
        ...
        h(
          "div",
          { className: "dsh-tw-footArea" },
          h(
            "div",
            { className: "dsh-tw-footerActions" },
            renderSlot("sidebar.footer.action", { wide: wide }),
          ),
          h(
            "div",
            { className: "dsh-tw-settingsArea" },
            renderSlot("sidebar.settings", { wide: wide }),
          ),
        ),
      );
    }
