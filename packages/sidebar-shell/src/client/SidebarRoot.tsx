      ...
      >
        {wide && showBrand ? (
          ...
          >
            ...
            {renderSlot('sidebar.brand.name', {}, { fallback: <span style={{ fontWeight: 600 }}>DSH</span> })}
          </button>
        ) : (
          <span aria-hidden="true" style={{ width: 32, height: 32 }}>
            {showBrand ? renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <FishLogo size={24} /> }) : null}
          </span>
        )}
