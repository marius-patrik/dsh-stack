...
const TOKEN = (ref: string): CredentialSlot => ({ slot: 'token', ref })
const API_KEY = (ref: string): CredentialSlot => ({ slot: 'apiKey', ref })
const HEADER = (headerName: string, ref: string): CredentialSlot => ({ slot: 'header', headerName, ref })
...
export const PROVIDER_ROUTES: readonly ProviderRoute[] = [
  {
    ...
    models: [
      { id: 'kimi-k3', name: 'Kimi K3', contextWindow: KIMI_K3_CONTEXT, maxTokens: KIMI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'kimi-k2.7-code', name: 'Kimi K2.7 Code', contextWindow: KIMI_CONTEXT, maxTokens: KIMI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'kimi-k2.6', name: 'Kimi K2.6', contextWindow: KIMI_CONTEXT, maxTokens: KIMI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'kimi-k2.5', name: 'Kimi K2.5', contextWindow: KIMI_CONTEXT, maxTokens: KIMI_MAX_OUTPUT },
      { id: 'kimi-k2.5-thinking', name: 'Kimi K2.5 Thinking', contextWindow: KIMI_CONTEXT, maxTokens: KIMI_MAX_OUTPUT, reasoning: EFFORTS },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'claude-opus-5', name: 'Claude Opus 5', contextWindow: CLAUDE_CONTEXT, maxTokens: CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-sonnet-5', name: 'Claude Sonnet 5', contextWindow: CLAUDE_CONTEXT, maxTokens: CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', contextWindow: CLAUDE_CONTEXT, maxTokens: CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-opus-4-8', name: 'Claude Opus 4.8', contextWindow: CLAUDE_CONTEXT, maxTokens: CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-haiku-4-5', name: 'Claude Haiku 4.5', contextWindow: 200_000, maxTokens: 64_000, reasoning: EFFORTS },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'grok-4.6', name: 'Grok 4.6', contextWindow: XAI_CONTEXT, maxTokens: XAI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'grok-4.5', name: 'Grok 4.5', contextWindow: XAI_CONTEXT, maxTokens: XAI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'grok-composer-2.5-fast', name: 'Grok Composer 2.5 Fast', contextWindow: XAI_CONTEXT, maxTokens: XAI_MAX_OUTPUT, reasoning: EFFORTS },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'gemini-3.6-flash', name: 'Gemini 3.6 Flash', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gemini-3.5-flash', name: 'Gemini 3.5 Flash', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT },
      { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gemini-3-pro', name: 'Gemini 3 Pro', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'gemini-3.7-flash', name: 'Gemini 3.7 Flash', contextWindow: 1_048_576, maxTokens: 65_535, reasoning: EFFORTS },
      { id: 'gemini-3.6-flash', name: 'Gemini 3.6 Flash', contextWindow: 1_048_576, maxTokens: 65_535 },
      { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', contextWindow: 1_048_576, maxTokens: 65_535, reasoning: EFFORTS },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'gpt-5', name: 'GPT-5', contextWindow: 400_000, maxTokens: OPENAI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gpt-4.1', name: 'GPT-4.1', contextWindow: 1_000_000, maxTokens: 32_000 },
      { id: 'gpt-4o-mini', name: 'GPT-4o mini', contextWindow: OPENAI_DEFAULT_CONTEXT, maxTokens: 16_000 },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'claude-sonnet-4-5', name: 'Claude Sonnet 4.5', contextWindow: CLAUDE_CONTEXT, maxTokens: CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-opus-4-1', name: 'Claude Opus 4.1', contextWindow: CLAUDE_CONTEXT, maxTokens: CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-haiku-4-5', name: 'Claude Haiku 4.5', contextWindow: 200_000, maxTokens: 64_000, reasoning: EFFORTS },
    ],
    defaultMaxTokens: CLAUDE_MAX_OUTPUT,
    defaultContextWindow: CLAUDE_CONTEXT,
  },
  {
    ...
    models: [
      { id: 'gemini-2.5-pro', name: 'Gemini 2.5 Pro', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT, reasoning: EFFORTS },
    ],
    defaultMaxTokens: GEMINI_MAX_OUTPUT,
    defaultContextWindow: GEMINI_CONTEXT,
  },
  {
    ...
    models: [
      { id: 'grok-4', name: 'Grok 4', contextWindow: XAI_CONTEXT, maxTokens: XAI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'grok-code-fast-1', name: 'Grok Code Fast', contextWindow: XAI_CONTEXT, maxTokens: XAI_MAX_OUTPUT },
    ],
    defaultMaxTokens: XAI_MAX_OUTPUT,
    defaultContextWindow: XAI_CONTEXT,
  },
  {
    ...
    models: [
      { id: 'deepseek-chat', name: 'DeepSeek Chat', contextWindow: DEEPSEEK_CONTEXT, maxTokens: DEEPSEEK_MAX_OUTPUT },
      { id: 'deepseek-reasoner', name: 'DeepSeek Reasoner', contextWindow: DEEPSEEK_CONTEXT, maxTokens: DEEPSEEK_MAX_OUTPUT, reasoning: EFFORTS },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'mistral-large-latest', name: 'Mistral Large', contextWindow: MISTRAL_CONTEXT, maxTokens: MISTRAL_MAX_OUTPUT },
      { id: 'mistral-medium-latest', name: 'Mistral Medium', contextWindow: MISTRAL_CONTEXT, maxTokens: MISTRAL_MAX_OUTPUT },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'llama-3.3-70b-versatile', name: 'Llama 3.3 70B', contextWindow: GROQ_CONTEXT, maxTokens: GROQ_MAX_OUTPUT },
      { id: 'llama-3.1-8b-instant', name: 'Llama 3.1 8B', contextWindow: GROQ_CONTEXT, maxTokens: GROQ_MAX_OUTPUT },
    ],
  ...
  },
  {
    ...
    models: [
      { id: 'openai/gpt-4o', name: 'OpenAI GPT-4o', contextWindow: OPENAI_DEFAULT_CONTEXT, maxTokens: 16_000 },
      { id: 'anthropic/claude-sonnet-4.5', name: 'Claude Sonnet 4.5', contextWindow: CLAUDE_CONTEXT, maxTokens: CLAUDE_MAX_OUTPUT },
    ],
    defaultMaxTokens: 16_000,
    defaultContextWindow: OPENAI_DEFAULT_CONTEXT,
  },
  {
    ...
    models: [
      ...
      { id: 'gpt-5.6-sol', name: 'GPT 5.6 Sol', contextWindow: 272_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gpt-5.6-terra', name: 'GPT 5.6 Terra', contextWindow: 272_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gpt-5.6-luna', name: 'GPT 5.6 Luna', contextWindow: 272_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gpt-5.5', name: 'GPT 5.5', contextWindow: 272_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gpt-5.4', name: 'GPT 5.4', contextWindow: 272_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gpt-5.3-codex', name: 'GPT 5.3 Codex', contextWindow: 272_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      // Claude family
      { id: 'claude-opus-5', name: 'Claude Opus 5', contextWindow: ZEN_CLAUDE_CONTEXT, maxTokens: ZEN_CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-opus-4-8', name: 'Claude Opus 4.8', contextWindow: ZEN_CLAUDE_CONTEXT, maxTokens: ZEN_CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-sonnet-5', name: 'Claude Sonnet 5', contextWindow: ZEN_CLAUDE_CONTEXT, maxTokens: ZEN_CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', contextWindow: ZEN_CLAUDE_CONTEXT, maxTokens: ZEN_CLAUDE_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'claude-haiku-4-5', name: 'Claude Haiku 4.5', contextWindow: 200_000, maxTokens: 64_000, reasoning: EFFORTS },
      // Gemini family
      { id: 'gemini-3.7-flash', name: 'Gemini 3.7 Flash', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gemini-3.6-flash', name: 'Gemini 3.6 Flash', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', contextWindow: GEMINI_CONTEXT, maxTokens: GEMINI_MAX_OUTPUT, reasoning: EFFORTS },
      // Grok family
      { id: 'grok-4.6', name: 'Grok 4.6', contextWindow: 200_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'grok-4.5', name: 'Grok 4.5', contextWindow: 200_000, maxTokens: ZEN_MAX_OUTPUT, reasoning: EFFORTS },
      // DeepSeek family
      { id: 'deepseek-v4-pro', name: 'DeepSeek V4 Pro', contextWindow: DEEPSEEK_CONTEXT, maxTokens: DEEPSEEK_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'deepseek-v4-flash', name: 'DeepSeek V4 Flash', contextWindow: DEEPSEEK_CONTEXT, maxTokens: DEEPSEEK_MAX_OUTPUT, reasoning: EFFORTS },
      // Kimi family
      { id: 'kimi-k3', name: 'Kimi K3', contextWindow: KIMI_K3_CONTEXT, maxTokens: KIMI_MAX_OUTPUT, reasoning: EFFORTS },
      { id: 'kimi-k2.7-code', name: 'Kimi K2.7 Code', contextWindow: KIMI_CONTEXT, maxTokens: KIMI_MAX_OUTPUT, reasoning: EFFORTS },
      // Qwen family
      { id: 'qwen3.7-max', name: 'Qwen 3.7 Max', contextWindow: ZEN_CONTEXT, maxTokens: ZEN_MAX_OUTPUT },
      { id: 'qwen3.7-plus', name: 'Qwen 3.7 Plus', contextWindow: ZEN_CONTEXT, maxTokens: ZEN_MAX_OUTPUT },
      // Free tier
      { id: 'deepseek-v4-flash-free', name: 'DeepSeek V4 Flash (Free)', contextWindow: DEEPSEEK_CONTEXT, maxTokens: DEEPSEEK_MAX_OUTPUT },
      { id: 'mimo-v2.5-free', name: 'MiMo-V2.5 (Free)', contextWindow: ZEN_CONTEXT, maxTokens: ZEN_MAX_OUTPUT },
    ],
