 ...
 * `@dsh-stack/sidebar-settings`, another inside `@dsh-stack/sidebar-shell`. A
 * module-local `Set` of listeners therefore only ever reaches the copy that was
 * mutated, which is why toggling a sidebar preference in Settings left the
 * sidebar itself unchanged.
 *
 ...
 *
 * @module @dsh-stack/sidebar-preferences/cross-bundle-channel
 */
